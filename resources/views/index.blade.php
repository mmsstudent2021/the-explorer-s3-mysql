    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-8">
                <h1 class="text-center mb-4">Min Ga Lar Par</h1>
                @auth
                ...
                <div class="posts">
                    ...
                    <div class="post mb-4">
                        <div class="row">
                            <div class="col-lg-4">
                                <img src="{{ Storage::disk("spaces")->url($post->cover) }}" class="cover-img rounded-3 w-100" alt="">
                            </div>
                            <div class="col-lg-8">
                                <div class="d-flex flex-column justify-content-between h-350 py-4">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex">
                                            <img src="{{ Storage::disk("spaces")->url($post->user->photo) }}" class="user-img rounded-circle" alt="">
